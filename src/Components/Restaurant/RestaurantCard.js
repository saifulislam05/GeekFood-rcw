      ...
      <div className="px-6 py-4">
        <div className="flex items-center mb-2">
          ...
          <div className="ml-2 flex">
            {Array.from({ length: ratingFloor }, (_, index) => (
              <RatingStar key={index} />
            ))}
            {ratingFloor !== rating && (
              <img className="w-5 h-5" alt="half rating" src="https://cdn-icons-png.flaticon.com/128/2107/2107737.png" />
            )}
          </div>
        </div>
